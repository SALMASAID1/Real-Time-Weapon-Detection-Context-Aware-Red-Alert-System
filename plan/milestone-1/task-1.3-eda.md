...
## Details
 1. [x] **Hard Negative Mining**: Integrate 5,000+ images of objects often mistaken for weapons (umbrellas, drills, wallets, smartphones).
 2. [x] **Synthetic Injection**: Use GANs or Simuletic data to simulate:
   - Adverse weather (rain, fog).
   - Low-light and night-time surveillance conditions.
 3. [x] **Validation**: Ensure the model is trained to explicitly ignore these confuser objects.
