...
## Description
Integrate Swin Transformer blocks into the model's neck within `models/swin_transformer.py` to capture long-range spatial dependencies.
...
3. **Context Awareness**: Leverage the self-attention mechanism to better distinguish weapons from background noise in complex scenes.
