...
## Details
 1. [x] **Heatmap Generation**: Generate visual heatmaps indicating which pixels influenced the model's classification.
 2. [x] **Bias Detection**: Use XAI to verify that the model is not relying on background context or biased elements.
 3. [x] **Integration**: Enable the Grad-CAM visualization for sample detections in the final dashboard.
