...
## Details
 1. [x] **Slicing Logic**: Divide high-resolution input images into overlapping patches (slices).
 2. [x] **Inference Pipeline**: Run detection on each slice and the full image simultaneously.
 3. [x] **Merging Results**: Use Non-Maximum Suppression (NMS) or Weighted Boxes Fusion (WBF) to merge detections from multiple slices into a final prediction.
